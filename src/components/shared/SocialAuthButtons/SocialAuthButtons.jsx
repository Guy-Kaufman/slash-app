...
const PROVIDERS = [
  ...
  },
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" width="18" height="18" aria-hidden="true">
        <path fill="currentColor" d="M16.365 1.43c0 1.14-.42 2.2-1.12 2.99-.84.96-2.2 1.7-3.32 1.6-.14-1.1.43-2.27 1.1-3 .77-.84 2.2-1.5 3.34-1.59zM20.5 17.2c-.55 1.27-.82 1.84-1.53 2.96-.99 1.57-2.39 3.52-4.12 3.53-1.54.02-1.94-1.01-4.03-1-2.09.01-2.53 1.02-4.07 1-1.73-.01-3.05-1.78-4.04-3.34C-.02 17.5-.32 13.07 1.4 10.62c.94-1.36 2.43-2.22 3.84-2.22 1.43 0 2.33 1.01 3.51 1.01 1.14 0 1.84-1.01 3.5-1.01 1.27 0 2.6.7 3.56 1.9-3.13 1.71-2.62 6.18.69 7.4z" />
      </svg>
    ),
  },
]
